...
const ApplicationReviewDetails: React.FC<ApplicationReviewDetailsProps> = ({ application }) => {
  ...
  const getReviewStatusBadge = (status: ReviewStatus) => {
    switch (status) {
      ...
      case 'IN_PROGRESS':
        return <Badge variant="outline" className="bg-yellow-50 text-yellow-600">In Progress</Badge>;
      case 'COMPLETED':
  ...
  return (
    <Tabs defaultValue="overview" className="w-full">
      <TabsList className="grid w-full grid-cols-3 mb-4">
        ...
        <TabsTrigger value="reviews">Reviews ({application.reviewsCompleted}/{application.reviewsTotal})</TabsTrigger>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card>
            ...
            <CardContent>
              <dl className="space-y-2">
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Startup Name</dt>
                ...
                <div>
                  ...
                  <dd className="text-sm mt-1">{formatDate(application.submittedAt)}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Application Rank</dt>
                  <dd className="text-sm mt-1 font-medium">#{application.rank}</dd>
                </div>
              </dl>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Aggregated scores from all completed reviews</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    <span className="text-lg font-bold mr-2">{application.averageScores.overall || 'N/A'}</span>
                    {application.averageScores.overall && (
                      <span className={`text-xs ${getScoreLabel(application.averageScores.overall).color}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{application.averageScores.innovation || 'N/A'}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{application.averageScores.market || 'N/A'}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{application.averageScores.team || 'N/A'}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{application.averageScores.execution || 'N/A'}</span>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <TabsContent value="reviews">
        {application.reviews.length === 0 ? (
          <div className="text-center py-8 border rounded-lg">
            <p className="text-muted-foreground">No reviews have been assigned yet.</p>
          </div>
        ) : (
          <div className="space-y-4">
                ...
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-start">
                    <div className="flex items-center">
                      ...
                      <div>
                        <CardTitle className="text-base">{review.reviewer.name || 'Anonymous Reviewer'}</CardTitle>
                        <CardDescription>{review.reviewer.email}</CardDescription>
                      </div>
                    </div>
                ...
                <CardContent>
                  {review.status === 'COMPLETED' ? (
                    ...
                    <div className="text-center py-4">
                      ...
                      <p className="text-muted-foreground">This review is not completed yet.</p>
                    </div>
                  )}
                </CardContent>
              </Card>
      ...
      <TabsContent value="entrepreneur">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Entrepreneur Information</CardTitle>
            <CardDescription>Details about the entrepreneur who submitted this application</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-medium">{application.user.name || 'Unnamed User'}</h3>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="capitalize">{application.status.toLowerCase().replace('_', ' ')}</span>
              </div>
            </div>
          </CardContent>
        </Card>
