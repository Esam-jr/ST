...
async function clearDatabase() {
  ...
  try {
    if (prisma.startupCallApplication) await prisma.startupCallApplication.deleteMany({});
  } catch (e) {
    console.log('Error deleting startup call applications:', e instanceof Error ? e.message : String(e));
  }
  
  try {
    if (prisma.startupCall) await prisma.startupCall.deleteMany({});
  } catch (e) {
    console.log('Error deleting startup calls:', e instanceof Error ? e.message : String(e));
  }
  ...
  try {
    ...
    console.log('Error deleting financials:', e instanceof Error ? e.message : String(e));
  }
