      ...
      <Layout title="Application Not Found">
        <div className="container max-w-6xl py-8">
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <Button className="mt-6" onClick={() => router.push('/admin/startup-calls')}>
      ...
      <div className="container max-w-6xl py-8">
        ...
        <div className="mb-6">
          <Button 
            ...
            size="sm" 
            className="mb-4 -ml-2"
            onClick={() => router.push('/admin/startup-calls')}
          >
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to Startup Calls
          </Button>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-base">{application.startupName}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-base">{formatDate(application.foundingDate)}</p>
                  </div>
                  
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">Team Size</h3>
                    <p className="text-base">{application.teamSize}</p>
                  </div>
                  
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">Industry</h3>
                    <p className="text-base">{application.industry}</p>
                  </div>
                  
                  <div>
                    <h3 className="text-sm font-medium text-muted-foreground">Stage</h3>
                    <p className="text-base">{application.stage}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="border rounded-md p-4">
                    ...
                    {application.pitchDeckUrl ? (
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Pitch Deck Document</span>
                        <Button 
                          variant="outline" 
                          size="sm"
                  ...
                  <div className="border rounded-md p-4">
                    ...
                    {application.financialsUrl ? (
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Financial Document</span>
                        <Button 
                          variant="outline" 
                          size="sm"
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-base">{application.user.name}</p>
                  </div>
